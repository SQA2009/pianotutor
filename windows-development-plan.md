...
- Build fixture library early: isolated notes, intervals, triads, wrong substitutions,
  early/late timing variants.
- Automated tests: note precision/recall, chord completeness accuracy, timing error
  distribution after latency compensation.
- Keep reproducible sample rates and reference metadata.

## 9) Primary Risks

- Polyphonic false positives in low register
- Device/driver latency variability
- Over-penalization under low confidence
- UI stalls from cross-thread contention
